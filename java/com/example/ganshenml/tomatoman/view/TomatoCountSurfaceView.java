...
public class TomatoCountSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private String paintColor, paintArcBackgroudColor, paintCircleBackgroundColor, paintTextColor;
...
//    private boolean isFirstShown = false;//作为一开始计时时快速走过一圈的动画（仅一次展示）
    ...
    public class CountThread extends Thread {
        ...
        Paint paint, paintArcBackgroud, paintCircleBackground, paintText;
        ...
        public CountThread(SurfaceHolder surfaceHolder) {
            ...
            if (paintColor != null) {//表示已经对颜色进行了设置，则使用该设置的颜色值
                ...
                paintArcBackgroud.setColor(Color.parseColor(paintArcBackgroudColor));
...
//                    canvas.drawRoundRect(300, 300, 600, 600, 150, 150, paint);//直接使用该行代码来画圆是行不通的，因为这个方法要求版本21，我的手机运行android版本是19
    ...
    public void setColor(String paintColor, String paintCircleBackgroundColor, String paintArcBackgroudColor, String paintTextColor) {
        this.paintColor = paintColor;
        this.paintArcBackgroudColor = paintArcBackgroudColor;
