 ...
 * 用来画休息的大大大圆view
 */
public class StartRestCircleView extends View {
    Paint paintCircle,paintText;
    public StartRestCircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTools();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画圆内的文字
        canvas.drawText("开始休息",pivotX,pivotX+30,paintText);
    }
